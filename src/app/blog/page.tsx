...
export const metadata = {
  title: "Írások",
  description:
    "Csendesebb, olvasható tudástár a jóga szemléletéről, a gyakorlásról és a belső útról.",
};
...
export default async function BlogPage({ searchParams }: { searchParams?: SearchParams }) {
  ...
  return (
    <>
      <PageHero
        eyebrow="Írások"
        title="Rövid írások a gyakorlásról, a figyelemről és a jóga mélyebb rétegeiről."
        description="A blog marad, de ugyanabban a nyugodt hangban: egyszerűen olvasható, kereshető, jól strukturált formában."
      />
