...
export default async function AdminBlogPage() {
  ...
  return (
    <AdminShell profile={profile} currentPath="/admin/blog">
      <AdminPageHeader
        title="Blog"
        description="Az adminban a blog marad aktív: új cikkeket lehet felvinni, sluggal, kategóriával, képpel és meta mezőkkel."
      />
      ...
      <div className="grid gap-6">
        ...
        >
          ...
          <div className="grid gap-2 md:col-span-2">
            <label className="text-sm font-semibold text-ink">Rövid bevezető</label>
            <input name="excerpt" className="input-field" />
          </div>
          <div className="grid gap-2 md:col-span-2">
            <label className="text-sm font-semibold text-ink">Tartalom</label>
            <textarea name="content" className="textarea-field min-h-56" />
          </div>
          <div className="grid gap-2">
